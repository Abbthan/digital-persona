...
Only extract supported information. Preserve meaningful wording for catchphrases and dialect. Do not infer sensitive attributes, diagnose emotion, or turn a fleeting statement into identity. Resolve dates only when supported; otherwise preserve the original expression. Questions should fill important missing context, not repeat facts. No markdown."""
