...
const zh: Record<string, string> = {
  ...
  "One 40-second guided scan per persona — re-scanning replaces it": "每个人格可保存一次 40 秒引导式扫描——重新扫描会替换原扫描", "One 20-second natural-motion scan per persona — re-scanning replaces it": "每个人格可保存一次 20 秒自然动态扫描——重新扫描会替换原扫描", "Look toward the camera and stay relaxed. Blink, breathe, and make small natural movements without speaking.": "请看向镜头并保持放松。自然眨眼、呼吸并做轻微动作，无需说话。", "Live video is enabled only after both the guided and passive facial scans are saved. Without both scans, the persona will remain available for chat only.": "只有保存引导式和自然动态两种面部扫描后，实时视频才会启用。若未完成两种扫描，该人格仍可进行文字聊天。", "Live video is enabled only after both the guided and passive facial scans are saved. Without both scans, the persona remains available for chat only.": "只有保存引导式和自然动态两种面部扫描后，实时视频才会启用。若未完成两种扫描，该人格仍可进行文字聊天。", "Complete both the guided and passive facial scans to enable live video. Chat remains available.": "请完成引导式和自然动态两种面部扫描以启用实时视频。文字聊天仍可使用。", "Couldn't save the passive facial scan. Please try again.": "无法保存自然动态面部扫描，请重试。",
