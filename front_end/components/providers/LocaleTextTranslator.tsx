...
function translateEnglishToChinese(value: string) {
  ...
  const photoLimit = core.match(/^Up to (\d+) JPG, PNG, or HEIC photos, 5 MB each$/);
  if (photoLimit) return `${leading}最多 ${photoLimit[1]} 张 JPG、PNG 或 HEIC 照片，每张最大 5 MB${trailing}`;
